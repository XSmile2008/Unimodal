...
public class Matrix {
    ...
    public static double determinant(final double A[][]) throws IncompatibleSizesExeption {
        int n = A.length;
    ...
    public static double[][] add(final double A[][], double B[][]) throws IncompatibleSizesExeption {
